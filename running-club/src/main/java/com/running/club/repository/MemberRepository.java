...
public interface MemberRepository extends JpaRepository<Member, Integer> {
    ...
    @Query("SELECT m FROM Member m LEFT JOIN FETCH m.runningGroup WHERE m.name = :name AND m.phone = :phone")
    ...
    @Query("SELECT m FROM Member m LEFT JOIN FETCH m.runningGroup WHERE m.id = :id")
